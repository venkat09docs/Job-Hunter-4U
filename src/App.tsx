...
import AICareerOffers from "./pages/AICareerOffers";
    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/gen-ai-career-accelerator" element={<GenAICareerAccelerator />} />
          <Route path="/ai-career-offers" element={<AICareerOffers />} />
