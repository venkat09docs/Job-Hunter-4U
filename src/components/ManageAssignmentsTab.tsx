  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => navigate('/career-level/assignments/new')}>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  <Button 
                    ...
                    size="sm" 
                    className="flex-1"
                    onClick={() => navigate(`/career-level/assignments/${assignment.id}`)}
                  >
                  ...
                  <Button 
                    variant="outline" 
                    size="sm"
                    onClick={() => navigate(`/career-level/assignments/${assignment.id}/edit`)}
                  >
