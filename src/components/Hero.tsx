...
const Hero = () => {
  ...
  return (
    <>
      <section id="hero" className="relative min-h-0 flex items-center justify-center overflow-visible pt-16 sm:pt-20 md:pt-24 pb-8 sm:pb-12 md:pb-16">
        {/* Background gradient */}
        <div className="absolute inset-0 bg-gradient-hero -z-10" />
        
        {/* Hero content */}
        <div className="container relative z-10 px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-start lg:items-center">
            {/* Text content */}
            <div className="space-y-5 sm:space-y-6 md:space-y-7 text-center lg:text-left order-2 lg:order-1">
              <div className="space-y-4 sm:space-y-5">
                ...
                <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed animate-fade-in animation-delay-200">
                ...
                <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-4 sm:p-5">
              ...
              <div className="space-y-3">
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 text-sm sm:text-base text-muted-foreground">
            ...
            <div className="relative order-1 lg:order-2 w-full">
              {/* Career Level Up Box */}
              <div className="relative bg-gradient-to-br from-purple-600/60 via-pink-600/50 to-indigo-600/60 backdrop-blur-md rounded-2xl p-4 sm:p-5 md:p-7 border-2 border-white/40 shadow-2xl overflow-visible">
                ...
                <div className="absolute inset-0 opacity-40 rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute top-1/4 right-0 w-64 h-64 md:w-96 md:h-96 bg-pink-500/50 rounded-full blur-3xl animate-pulse"></div>
                  <div className="absolute bottom-1/4 left-0 w-48 h-48 md:w-72 md:h-72 bg-cyan-500/50 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
                </div>
                
                {/* Career Success Steps Image */}
                <div className="relative z-10 mb-4 sm:mb-5 rounded-xl overflow-hidden shadow-2xl">
                  <img 
                ...
                <div className="text-center mb-3 sm:mb-4 relative z-10">
                  <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-white mb-2 drop-shadow-2xl" style={{
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2 sm:gap-2.5 relative z-10">
                  <div className="bg-gradient-to-r from-yellow-500 to-orange-500 rounded-lg p-2 sm:p-2.5 transform hover:scale-105 transition-all duration-300 shadow-lg border border-white/30">
                    <div className="flex items-center justify-center gap-1.5">
                      <FileText className="h-4 w-4 sm:h-4 sm:w-4 text-white flex-shrink-0" />
                      <span className="text-white font-bold text-xs sm:text-sm drop-shadow-lg truncate">Resume</span>
                    </div>
                  </div>
                  
                  <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg p-2 sm:p-2.5 transform hover:scale-105 transition-all duration-300 shadow-lg border border-white/30">
                    <div className="flex items-center justify-center gap-1.5">
                      <User className="h-4 w-4 sm:h-4 sm:w-4 text-white flex-shrink-0" />
                      <span className="text-white font-bold text-xs sm:text-sm drop-shadow-lg truncate">Portfolio</span>
                    </div>
                  </div>
                  
                  <div className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg p-2 sm:p-2.5 transform hover:scale-105 transition-all duration-300 shadow-lg border border-white/30">
                    <div className="flex items-center justify-center gap-1.5">
                      <Briefcase className="h-4 w-4 sm:h-4 sm:w-4 text-white flex-shrink-0" />
                      <span className="text-white font-bold text-xs sm:text-sm drop-shadow-lg truncate">Job Hunt</span>
                    </div>
                  </div>
                  
                  <div className="bg-gradient-to-r from-green-500 to-teal-500 rounded-lg p-2 sm:p-2.5 transform hover:scale-105 transition-all duration-300 shadow-lg border border-white/30">
                    <div className="flex items-center justify-center gap-1.5">
                      <Users className="h-4 w-4 sm:h-4 sm:w-4 text-white flex-shrink-0" />
                      <span className="text-white font-bold text-xs sm:text-sm drop-shadow-lg truncate">LinkedIn</span>
                    </div>
                  </div>

                  <div className="bg-gradient-to-r from-gray-700 to-gray-900 rounded-lg p-2 sm:p-2.5 transform hover:scale-105 transition-all duration-300 shadow-lg border border-white/30 col-span-2 sm:col-span-1">
                    <div className="flex items-center justify-center gap-1.5">
                      <Target className="h-4 w-4 sm:h-4 sm:w-4 text-white flex-shrink-0" />
                      <span className="text-white font-bold text-xs sm:text-sm drop-shadow-lg truncate">GitHub</span>
                    </div>
                  </div>
                </div>
              </div>
