...
import { Trophy, Calendar, Activity, Star, ChevronLeft, ChevronRight, User } from "lucide-react";
import { useAdminPointsHistory } from "@/hooks/useAdminPointsHistory";

interface AdminPointsHistoryDialogProps {
  open: boolean;
...
export function AdminPointsHistoryDialog({ open, onOpenChange, userId }: AdminPointsHistoryDialogProps) {
  const { pointsHistory, loading, totalPoints, userInfo } = useAdminPointsHistory(userId);
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            <DialogTitle>
              {userInfo?.full_name || userInfo?.username || 'User'} - Points History
            </DialogTitle>
          </div>
          <DialogDescription>
            Track user's activity points and achievements
          </DialogDescription>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-muted-foreground">
                This user hasn't completed any activities to earn points yet.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
