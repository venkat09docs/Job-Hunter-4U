...
interface GitHubRequestReenableDialogProps {
  taskId: string;
  taskTitle: string;
  onRequestSent?: () => void;
}

export const GitHubRequestReenableDialog: React.FC<GitHubRequestReenableDialogProps> = ({
  taskId,
  taskTitle,
  onRequestSent
}) => {
  ...
  const handleSubmitRequest = async () => {
    ...
    try {
      ...
      console.error('Error sending GitHub extension request:', error);
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              The due date for this GitHub task has passed. You can request an admin to extend the deadline if you're still within the same week.
            </p>
          </div>
