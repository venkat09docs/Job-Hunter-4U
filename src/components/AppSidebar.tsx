...
const mainItems = [
  ...
  { title: "Career Growth Report", url: "/dashboard/career-growth", icon: BarChart3, featureKey: "page_career_growth" },
  { title: "AI-Powered Career Tools", url: "/dashboard/digital-career-hub", icon: Zap, featureKey: "page_digital_career_hub" },
  { title: "Super AI", url: "/dashboard/super-ai", icon: Bot, featureKey: "page_super_ai" },
  { title: "Digital Portfolio", url: "/dashboard/digital-portfolio", icon: Briefcase, featureKey: "page_digital_portfolio" },
