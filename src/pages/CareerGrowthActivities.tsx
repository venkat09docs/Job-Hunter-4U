...
import { JOB_APP_TASKS, LINKEDIN_DAILY_ACTIVITIES as DAILY_ACTIVITIES } from '@/constants/activities';
...
// LinkedIn activities moved to shared constants (see src/constants/activities.ts)


// Job application tasks moved to shared constants (see src/constants/activities.ts)
