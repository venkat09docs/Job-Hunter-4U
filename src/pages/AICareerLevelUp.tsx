            ...
            <div>
              ...
              <div className="flex gap-4">
                <Button 
                  variant="outline" 
                  size="icon" 
                  className="h-12 w-12 border-gray-700 text-gray-400 hover:bg-purple-600/20 hover:border-purple-400 hover:text-white transition-colors bg-gray-800/50"
                  asChild
                >
                ...
                <Button 
                  variant="outline" 
                  size="icon" 
                  className="h-12 w-12 border-gray-700 text-gray-400 hover:bg-red-600/20 hover:border-red-400 hover:text-white transition-colors bg-gray-800/50"
                  asChild
                >
                ...
                <Button 
                  variant="outline" 
                  size="icon" 
                  className="h-12 w-12 border-gray-700 text-gray-400 hover:bg-pink-600/20 hover:border-pink-400 hover:text-white transition-colors bg-gray-800/50"
                  asChild
                >
                  <a href="https://www.instagram.com/rnstechnologies?igsh=MTM1emgzOHQxczJteg==&utm_source=ig_contact_invite" target="_blank" rel="noopener noreferrer">
                    ...
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.618 5.367 11.986 11.988 11.986c6.618 0 11.986-5.368 11.986-11.986C24.003 5.367 18.635.001 12.017.001zM8.449 16.988c-1.297 0-2.348-1.051-2.348-2.348c0-1.297 1.051-2.348 2.348-2.348c1.297 0 2.348 1.051 2.348 2.348C10.797 15.937 9.746 16.988 8.449 16.988zM12.017 16.988c-1.297 0-2.348-1.051-2.348-2.348c0-1.297 1.051-2.348 2.348-2.348c1.297 0 2.348 1.051 2.348 2.348C14.365 15.937 13.314 16.988 12.017 16.988zM15.586 16.988c-1.297 0-2.348-1.051-2.348-2.348c0-1.297 1.051-2.348 2.348-2.348c1.297 0 2.348 1.051 2.348 2.348C17.934 15.937 16.883 16.988 15.586 16.988zM8.449 13.292c-1.297 0-2.348-1.051-2.348-2.348c0-1.297 1.051-2.348 2.348-2.348c1.297 0 2.348 1.051 2.348 2.348C10.797 12.241 9.746 13.292 8.449 13.292zM12.017 13.292c-1.297 0-2.348-1.051-2.348-2.348c0-1.297 1.051-2.348 2.348-2.348c1.297 0 2.348 1.051 2.348 2.348C14.365 12.241 13.314 13.292 12.017 13.292zM15.586 13.292c-1.297 0-2.348-1.051-2.348-2.348c0-1.297 1.051-2.348 2.348-2.348c1.297 0 2.348 1.051 2.348 2.348C17.934 12.241 16.883 13.292 15.586 13.292zM8.449 9.595c-1.297 0-2.348-1.051-2.348-2.348c0-1.297 1.051-2.348 2.348-2.348c1.297 0 2.348 1.051 2.348 2.348C10.797 8.544 9.746 9.595 8.449 9.595zM12.017 9.595c-1.297 0-2.348-1.051-2.348-2.348c0-1.297 1.051-2.348 2.348-2.348c1.297 0 2.348 1.051 2.348 2.348C14.365 8.544 13.314 9.595 12.017 9.595zM15.586 9.595c-1.297 0-2.348-1.051-2.348-2.348c0-1.297 1.051-2.348 2.348-2.348c1.297 0 2.348 1.051 2.348 2.348C17.934 8.544 16.883 9.595 15.586 9.595z"/>
                    </svg>
                  </a>
                </Button>
              </div>
