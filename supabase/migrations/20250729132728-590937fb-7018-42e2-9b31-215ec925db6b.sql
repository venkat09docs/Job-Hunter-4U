-- Add institute_admin role to the enum
ALTER TYPE app_role ADD VALUE 'institute_admin';
...
DROP POLICY "Admins can manage institutes" ON public.institutes;
...
DROP POLICY "Admins can manage batches" ON public.batches;
...
DROP POLICY "Admins can manage user assignments" ON public.user_assignments;
