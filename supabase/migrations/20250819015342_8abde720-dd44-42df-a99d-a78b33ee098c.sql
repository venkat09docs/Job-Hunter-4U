-- Seed task templates for the Career Assignments system with valid categories

-- Resume Tasks (using content_creation as it's the closest fit)
...
('RESUME_UPLOAD_PRIMARY', 'RESUME', 'Upload Your Primary Resume', 'Upload your main resume as a PDF file', 'content_creation', ARRAY['data_export'], 10, 'oneoff', 'easy', 15, 
...
('RESUME_TAILOR_TO_ROLE', 'RESUME', 'Tailor Resume to Target Role', 'Customize your resume for a specific job role with relevant keywords', 'content_creation', ARRAY['data_export'], 12, 'oneoff', 'medium', 30,
...
('RESUME_STAR_BULLETS', 'RESUME', 'Convert 5 Bullets to STAR Format', 'Rewrite 5 bullet points using Situation, Task, Action, Result format with metrics', 'content_creation', ARRAY['data_export', 'screenshot'], 8, 'oneoff', 'medium', 45,
...
('RESUME_LINKS_SECTION', 'RESUME', 'Add Professional Links Section', 'Include LinkedIn, GitHub, and portfolio links in your resume', 'content_creation', ARRAY['data_export', 'screenshot'], 8, 'oneoff', 'easy', 20,
...
('RESUME_ATS_SCORE_PASS', 'RESUME', 'Pass Baseline ATS Score', 'Ensure your resume passes basic Applicant Tracking System requirements', 'content_creation', ARRAY['data_export'], 10, 'oneoff', 'medium', 25,
...
-- LinkedIn Tasks  
INSERT INTO career_task_templates (code, module, title, description, category, evidence_types, points_reward, cadence, difficulty, estimated_duration, instructions, verification_criteria, bonus_rules) VALUES
('LI_HEADLINE_70', 'LINKEDIN', 'Optimize Headline (70-120 chars)', 'Create a compelling LinkedIn headline with 70-120 characters including keywords', 'linkedin_growth', ARRAY['screenshot', 'url'], 10, 'oneoff', 'easy', 20,
...
('LI_ABOUT_200', 'LINKEDIN', 'Write About Section (200+ words)', 'Craft an outcome-oriented About section with at least 200 words', 'linkedin_growth', ARRAY['screenshot'], 12, 'oneoff', 'medium', 35,
...
('LI_CUSTOM_URL', 'LINKEDIN', 'Set Custom Profile URL', 'Create a custom LinkedIn profile URL with your name', 'linkedin_growth', ARRAY['url', 'screenshot'], 8, 'oneoff', 'easy', 10,
...
('LI_FEATURED_2', 'LINKEDIN', 'Add 2 Featured Items', 'Add 2 featured posts or external links to showcase your work', 'linkedin_growth', ARRAY['url', 'screenshot'], 10, 'oneoff', 'medium', 25,
...
('LI_SKILLS_25', 'LINKEDIN', 'Add 25+ Skills & Pin Top 3', 'Add at least 25 relevant skills and pin your top 3 most important ones', 'linkedin_growth', ARRAY['screenshot'], 8, 'oneoff', 'easy', 15,
...
('LI_ACTIVITY_KICKOFF', 'LINKEDIN', 'Weekly Activity: 1 Post + 3 Comments', 'Create 1 meaningful post and leave 3 thoughtful comments on others posts', 'networking', ARRAY['url', 'email', 'screenshot'], 15, 'weekly', 'medium', 60,
...
-- GitHub Tasks (using content_creation as closest fit)
INSERT INTO career_task_templates (code, module, title, description, category, evidence_types, points_reward, cadence, difficulty, estimated_duration, instructions, verification_criteria, bonus_rules) VALUES  
('GH_USERNAME_SET', 'GITHUB', 'Save GitHub Profile URL', 'Provide your GitHub username and profile URL for verification', 'content_creation', ARRAY['url'], 8, 'oneoff', 'easy', 5,
...
('GH_PORTFOLIO_REPO', 'GITHUB', 'Create Portfolio Repository', 'Create a portfolio repository with a comprehensive README file', 'content_creation', ARRAY['url', 'screenshot'], 12, 'oneoff', 'medium', 45,
...
('GH_PIN_3_REPOS', 'GITHUB', 'Pin 3 Relevant Repositories', 'Pin your 3 most relevant repositories to showcase your best work', 'content_creation', ARRAY['url', 'screenshot'], 10, 'oneoff', 'easy', 15,
...
('GH_TOPICS_ADD', 'GITHUB', 'Add 5+ Topics Across Repositories', 'Add at least 5 relevant topics/tags across your repositories', 'content_creation', ARRAY['screenshot'], 8, 'oneoff', 'easy', 20,
...
('GH_COMMIT_3DAYS', 'GITHUB', 'Commit on 3 Distinct Days', 'Make commits on at least 3 different days this week', 'content_creation', ARRAY['url'], 15, 'weekly', 'easy', 30,
...
('GH_PROFILE_README', 'GITHUB', 'Create Profile README', 'Create a special README for your GitHub profile (username/username repository)', 'content_creation', ARRAY['url', 'screenshot'], 12, 'oneoff', 'medium', 30,
