...
-- Update institutes policies - first drop existing ones
...
-- Create new policies for institutes
...
-- Update batches policies - first drop existing ones
DROP POLICY IF EXISTS "Admins can manage batches" ON public.batches;
DROP POLICY IF EXISTS "Users can view active batches" ON public.batches;
...
-- Update user_assignments policies - first drop existing ones
DROP POLICY IF EXISTS "Admins can manage user assignments" ON public.user_assignments;
DROP POLICY IF EXISTS "Users can view their own assignments" ON public.user_assignments;

-- Create new policies for user_assignments
