...
(
  ...
  '{"steps": ["Identify target companies", "Find connections at those companies", "Craft personalized referral requests", "Send messages via LinkedIn/email"], "tips": ["Mention specific roles you''re interested in", "Offer to share your resume", "Be respectful of their time"]}'::jsonb,
  '{}'::jsonb
),
...
(
  ...
  '{"steps": ["Identify contacts at the company", "Craft personalized referral request", "Include job link and your resume", "Send via LinkedIn or email"], "tips": ["Be specific about the role", "Explain why you''re a good fit", "Make it easy for them to help"]}'::jsonb,
  '{}'::jsonb
),
