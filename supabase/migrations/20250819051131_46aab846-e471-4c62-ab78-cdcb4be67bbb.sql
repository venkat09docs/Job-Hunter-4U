-- GITHUB WEEKLY SYSTEM SCHEMA - CORRECTED
...
('REPO', 'GHS_DEMO_ASSETS', 'Add demo GIF/screenshot in README', 'Include visual demonstrations of your project in the README', ARRAY['URL_REQUIRED'::evidence_type, 'SCREENSHOT_OK'::evidence_type], 8, '{"interactive_demo": 4}');
