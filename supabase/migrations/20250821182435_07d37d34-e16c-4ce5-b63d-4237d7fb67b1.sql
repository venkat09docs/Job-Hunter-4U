-- Add 9 Resume Task Templates for Profile Assignments
...
INSERT INTO public.career_task_templates (
  ...
  (
    ...
    'RESUME',
    'Add Professional Links Section',
    'Include LinkedIn, GitHub, and portfolio links in your resume',
    'Resume Building',
  ...
  (
    'RESUME_TOP_6_SKILLS',
    'RESUME',
    'Generate top 6 skills as per Your Role',
    'Use AI Powered Career Tool - Resume Builder Top 6 Skills to generate relevant skills',
    'Resume Building',
  ...
  (
    ...
    'RESUME',
    'Generate Achievements or Roles and Responsibilities',
    'Use AI Powered Career Tool - Resume Builder Achievements to create compelling content',
    'Resume Building',
    ARRAY['screenshot', 'file', 'data_export'],
    10,
    'oneoff',
  ...
  (
    ...
    'Use AI Powered Career Tool - Generate Resume Summary to create professional summary',
    'Resume Building',
    ARRAY['screenshot', 'file', 'data_export'],
    10,
    'oneoff',
  ...
  (
    ...
    'RESUME',
    'Add Educational, Certification, Awards details',
  ...
  (
    ...
    'RESUME',
    'Pass Baseline ATS Score',
    'Use AI Powered Career Tool - Resume Score Tracking to meet ATS requirements',
    'Resume Optimization',
  ...
  (
    ...
    'RESUME',
    'Upload/Save Your Primary Resume as Default Resume',
...
-- Add Assignment #5 (was missing in original list, but keeping numbering consistent)
INSERT INTO public.career_task_templates (
  code,
  module, 
  title,
  ...
  'RESUME',
  'Complete Resume Profile Information',
