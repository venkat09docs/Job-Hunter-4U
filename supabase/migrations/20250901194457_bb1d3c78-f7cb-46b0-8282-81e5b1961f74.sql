...
-- Institute admins can manage LinkedIn tasks for their institute users
...
-- Institute admins can manage job hunting assignments for their institute users
...
-- Institute admins can manage GitHub tasks for their institute users
