...
-- GitHub Tasks
INSERT INTO career_task_templates (code, module, title, description, category, evidence_types, points_reward, cadence, difficulty, estimated_duration, instructions, verification_criteria, bonus_rules) VALUES  
('GH_USERNAME_SET', 'GITHUB', 'Save GitHub Profile URL', 'Provide your GitHub username and profile URL for verification', 'github_optimization', ARRAY['url'], 8, 'oneoff', 'easy', 5,
...
('GH_PORTFOLIO_REPO', 'GITHUB', 'Create Portfolio Repository', 'Create a portfolio repository with a comprehensive README file', 'github_optimization', ARRAY['url', 'screenshot'], 12, 'oneoff', 'medium', 45,
...
('GH_PIN_3_REPOS', 'GITHUB', 'Pin 3 Relevant Repositories', 'Pin your 3 most relevant repositories to showcase your best work', 'github_optimization', ARRAY['url', 'screenshot'], 10, 'oneoff', 'easy', 15,
...
('GH_TOPICS_ADD', 'GITHUB', 'Add 5+ Topics Across Repositories', 'Add at least 5 relevant topics/tags across your repositories', 'github_optimization', ARRAY['screenshot'], 8, 'oneoff', 'easy', 20,
...
('GH_COMMIT_3DAYS', 'GITHUB', 'Commit on 3 Distinct Days', 'Make commits on at least 3 different days this week', 'github_optimization', ARRAY['url'], 15, 'weekly', 'easy', 30,
...
('GH_PROFILE_README', 'GITHUB', 'Create Profile README', 'Create a special README for your GitHub profile (username/username repository)', 'github_optimization', ARRAY['url', 'screenshot'], 12, 'oneoff', 'medium', 30,
