-- Seed task templates for the Career Assignments system with correct categories

-- Resume Tasks (using existing category pattern)
...
('RESUME_UPLOAD_PRIMARY', 'RESUME', 'Upload Your Primary Resume', 'Upload your main resume as a PDF file', 'resume_building', ARRAY['data_export'], 10, 'oneoff', 'easy', 15, 
...
('RESUME_TAILOR_TO_ROLE', 'RESUME', 'Tailor Resume to Target Role', 'Customize your resume for a specific job role with relevant keywords', 'resume_building', ARRAY['data_export'], 12, 'oneoff', 'medium', 30,
...
('RESUME_STAR_BULLETS', 'RESUME', 'Convert 5 Bullets to STAR Format', 'Rewrite 5 bullet points using Situation, Task, Action, Result format with metrics', 'resume_building', ARRAY['data_export', 'screenshot'], 8, 'oneoff', 'medium', 45,
...
('RESUME_LINKS_SECTION', 'RESUME', 'Add Professional Links Section', 'Include LinkedIn, GitHub, and portfolio links in your resume', 'resume_building', ARRAY['data_export', 'screenshot'], 8, 'oneoff', 'easy', 20,
...
('RESUME_ATS_SCORE_PASS', 'RESUME', 'Pass Baseline ATS Score', 'Ensure your resume passes basic Applicant Tracking System requirements', 'resume_building', ARRAY['data_export'], 10, 'oneoff', 'medium', 25,
...
('LI_ACTIVITY_KICKOFF', 'LINKEDIN', 'Weekly Activity: 1 Post + 3 Comments', 'Create 1 meaningful post and leave 3 thoughtful comments on others posts', 'linkedin_growth', ARRAY['url', 'email', 'screenshot'], 15, 'weekly', 'medium', 60,
...
-- GitHub Tasks  
INSERT INTO career_task_templates (code, module, title, description, category, evidence_types, points_reward, cadence, difficulty, estimated_duration, instructions, verification_criteria, bonus_rules) VALUES  
('GH_USERNAME_SET', 'GITHUB', 'Save GitHub Profile URL', 'Provide your GitHub username and profile URL for verification', 'github_profile', ARRAY['url'], 8, 'oneoff', 'easy', 5,
...
('GH_PORTFOLIO_REPO', 'GITHUB', 'Create Portfolio Repository', 'Create a portfolio repository with a comprehensive README file', 'github_profile', ARRAY['url', 'screenshot'], 12, 'oneoff', 'medium', 45,
...
('GH_PIN_3_REPOS', 'GITHUB', 'Pin 3 Relevant Repositories', 'Pin your 3 most relevant repositories to showcase your best work', 'github_profile', ARRAY['url', 'screenshot'], 10, 'oneoff', 'easy', 15,
...
('GH_TOPICS_ADD', 'GITHUB', 'Add 5+ Topics Across Repositories', 'Add at least 5 relevant topics/tags across your repositories', 'github_profile', ARRAY['screenshot'], 8, 'oneoff', 'easy', 20,
...
('GH_COMMIT_3DAYS', 'GITHUB', 'Commit on 3 Distinct Days', 'Make commits on at least 3 different days this week', 'github_profile', ARRAY['url'], 15, 'weekly', 'easy', 30,
...
('GH_PROFILE_README', 'GITHUB', 'Create Profile README', 'Create a special README for your GitHub profile (username/username repository)', 'github_profile', ARRAY['url', 'screenshot'], 12, 'oneoff', 'medium', 30,
