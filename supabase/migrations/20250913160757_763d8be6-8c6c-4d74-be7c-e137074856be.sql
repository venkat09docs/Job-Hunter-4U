...
-- Use a system admin user ID or create a system assignment approach
INSERT INTO user_assignments (
  ...
  'manual_assignment',
  '20e2d82b-ebe4-49c7-88d1-4463ff12b038', -- assign Kent to himself for now (system assignment)
  true
);
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    INSERT INTO public.user_assignments (
      ...
      target_batch_id,
      'auto_signup',
      NEW.user_id, -- Self-assignment for system automation
      true
    );
