-- Create or update the cron job to run the weekly GitHub assignments refresh
...
-- First, remove any existing similar cron jobs
SELECT cron.unschedule('weekly-github-assignments-refresh');

-- Create the new cron job to run every Monday at midnight (00:00)
