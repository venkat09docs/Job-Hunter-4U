...
CREATE POLICY "Users can view their own career assignments"
ON career_task_assignments FOR SELECT 
TO authenticated
USING (auth.uid() = user_id);

CREATE POLICY "Users can insert their own career assignments"
ON career_task_assignments FOR INSERT 
TO authenticated
WITH CHECK (auth.uid() = user_id);

CREATE POLICY "Users can update their own career assignments"
ON career_task_assignments FOR UPDATE 
TO authenticated
USING (auth.uid() = user_id);

CREATE POLICY "Admins can manage all career assignments"
...
CREATE POLICY "Institute admins can manage their institute user career assignments"
ON career_task_assignments FOR ALL
TO authenticated
USING (
  auth.uid() IS NOT NULL AND
...
CREATE POLICY "Recruiters can manage non-institute user career assignments"
ON career_task_assignments FOR ALL
TO authenticated
USING (
  auth.uid() IS NOT NULL AND
...
CREATE POLICY "Users can view and update their own LinkedIn tasks"
ON linkedin_user_tasks FOR ALL
TO authenticated
USING (auth.uid() = user_id AND auth.uid() IS NOT NULL);

CREATE POLICY "Admins can manage all LinkedIn user tasks"
ON linkedin_user_tasks FOR ALL
TO authenticated
USING (
  auth.uid() IS NOT NULL AND 
...
CREATE POLICY "Users can manage their own job hunting assignments"
...
CREATE POLICY "Users can manage their own GitHub tasks"
...
CREATE POLICY "Service role can manage career assignments"
ON career_task_assignments FOR ALL
