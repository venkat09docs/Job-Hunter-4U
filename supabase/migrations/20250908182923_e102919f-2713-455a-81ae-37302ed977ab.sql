...
-- Insert seed data
INSERT INTO public.clp_courses (title, code, description, created_by) VALUES
('Web Development Fundamentals', 'WEB101', 'Learn the basics of web development including HTML, CSS, and JavaScript', auth.uid()),
('Advanced Programming Concepts', 'PROG201', 'Master advanced programming concepts and design patterns', auth.uid());

INSERT INTO public.clp_modules (course_id, title, description, order_index) VALUES
((SELECT id FROM clp_courses WHERE code = 'WEB101'), 'HTML & CSS Basics', 'Introduction to HTML structure and CSS styling', 1),
((SELECT id FROM clp_courses WHERE code = 'WEB101'), 'JavaScript Fundamentals', 'Learn JavaScript programming basics', 2),
((SELECT id FROM clp_courses WHERE code = 'PROG201'), 'Object-Oriented Programming', 'Understanding OOP principles and patterns', 1);

-- Sample MCQ Assignment
INSERT INTO public.clp_assignments (
  module_id, title, type, instructions, 
  visible_from, start_at, end_at, due_at, 
  duration_minutes, max_attempts, is_published, created_by
) VALUES (
  (SELECT id FROM clp_modules WHERE title = 'HTML & CSS Basics'),
  'HTML Basics Quiz',
  'mcq',
...
INSERT INTO public.clp_questions (assignment_id, kind, prompt, options, correct_answers, marks, order_index) VALUES
(
  (SELECT id FROM clp_assignments WHERE title = 'HTML Basics Quiz'),
  'mcq',
...
INSERT INTO public.clp_assignments (
  ...
  (SELECT id FROM clp_modules WHERE title = 'JavaScript Fundamentals'),
...
INSERT INTO public.clp_questions (assignment_id, kind, prompt, marks, order_index) VALUES
(
  (SELECT id FROM clp_assignments WHERE title = 'JavaScript Concepts Essay'),
  'descriptive',
